...
<head>
    ...
    <title>Inventory LTDA- Cadastrar</title>
                            ...
                            <form method="post" class="user" action="<c:url value="cadastrar/salvausuario"/>">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input name="usuario.nome" value="${ usuario.nome}" minlength="3" maxlength="15" type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Nome">
                                    </div>
                                </div>
